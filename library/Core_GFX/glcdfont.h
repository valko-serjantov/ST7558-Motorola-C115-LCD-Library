...
static  unsigned char font5x8[][5] PROGMEM =
{
    ...
    { 0x7C, 0x55, 0x54, 0x55, 0x44 },   //8F- Џ Ё 143
    ...
    { 0x44, 0x45, 0x7C, 0x45, 0x44 },   //AF- Ї 176
    { 0x00, 0x00, 0x00, 0x00, 0x00 },   //B0- °	177
    { 0x00, 0x00, 0x00, 0x00, 0x00 },   //B1- ± 178
    { 0x00, 0x41, 0x7F, 0x41, 0x00 },   //B2- І 179
    { 0x00, 0x44, 0x7D, 0x40, 0x00 },   //B3- і 180
    { 0x00, 0x00, 0x00, 0x00, 0x00 },   //B4- ґ 181
    { 0x00, 0x00, 0x00, 0x00, 0x00 },   //B5- µ
    { 0x00, 0x00, 0x00, 0x00, 0x00 },   //B6- ¶
    { 0x00, 0x00, 0x00, 0x00, 0x00 },   //B7- ·	
    { 0x38, 0x55, 0x54, 0x55, 0x18 },   //B8- ё 184
    { 0x00, 0x00, 0x00, 0x00, 0x00 },   //B9- № 185
    { 0x38, 0x54, 0x44, 0x28, 0x00 },   //BA- є 186
    { 0x00, 0x00, 0x00, 0x00, 0x00 },   //BB- » 187
    { 0x00, 0x00, 0x00, 0x00, 0x00 },   //BC- ј 188
    { 0x00, 0x00, 0x00, 0x00, 0x00 },   //BD- Ѕ 189
    { 0x00, 0x00, 0x00, 0x00, 0x00 },   //BE- ѕ 190
    { 0x4A, 0x48, 0x7A, 0x40, 0x40 },   //BF- ї 191
    //Русские
    ...
    { 0x22, 0x49, 0x49, 0x49, 0x36 }, // З	199
    { 0x7F, 0x10, 0x08, 0x04, 0x7F }, // И	200	
    { 0x7F, 0x10, 0x09, 0x04, 0x7F }, // И	201
    { 0x7F, 0x08, 0x14, 0x22, 0x41 }, // K	202
    { 0x7C, 0x02, 0x01, 0x01, 0x7F }, // Л	203
    { 0x7F, 0x02, 0x0C, 0x02, 0x7F }, // M	204
    ...
    { 0x07, 0x48, 0x48, 0x48, 0x3F }, // У	211
    ...
    { 0x22, 0x49, 0x49, 0x49, 0x3E }, // Э	221
    { 0x7F, 0x08, 0x3E, 0x41, 0x3E }, // Ю	222
    { 0x46, 0x29, 0x19, 0x09, 0x7F }, // Я	223
    { 0x20, 0x54, 0x54, 0x54, 0x78 }, // a	224
    { 0x78, 0x54, 0x54, 0x54, 0x20 }, // b	225
    { 0x7C, 0x54, 0x54, 0x54, 0x28 }, // в	226
    { 0x7C, 0x04, 0x04, 0x04, 0x00 }, // г	227
    { 0x60, 0x38, 0x24, 0x38, 0x60 }, // д	228
    { 0x38, 0x54, 0x54, 0x54, 0x18 }, // e	229         
    { 0x6C, 0x10, 0x7C, 0x10, 0x6C }, // ж	230
    { 0x28, 0x44, 0x54, 0x54, 0x28 }, // з	231
    { 0x3C, 0x40, 0x40, 0x20, 0x7C }, // и	232
    { 0x3C, 0x40, 0x42, 0x20, 0x7C }, // й	233
    { 0x7C, 0x10, 0x10, 0x28, 0x44 }, // к	234
    { 0x60, 0x10, 0x08, 0x04, 0x7C }, // л	235
    { 0x7C, 0x08, 0x10, 0x08, 0x7C }, // м	237
    { 0x7C, 0x10, 0x10, 0x10, 0x7C }, // н	238
    { 0x38, 0x44, 0x44, 0x44, 0x38 }, // o	239
    { 0x7C, 0x04, 0x04, 0x04, 0x7C }, // п	240
    { 0x7C, 0x14, 0x14, 0x14, 0x08 }, // p	241
    { 0x38, 0x44, 0x44, 0x44, 0x20 }, // c	242
    { 0x04, 0x04, 0x7C, 0x04, 0x04 }, // т	243
    { 0x0C, 0x50, 0x50, 0x50, 0x3C }, // y	244
    { 0x18, 0x24, 0x7C, 0x24, 0x18 }, // ф	245
    { 0x44, 0x28, 0x10, 0x28, 0x44 }, // x	246
    { 0x3C, 0x20, 0x20, 0x3C, 0x60 }, // ц	247
    { 0x0C, 0x10, 0x10, 0x10, 0x7C }, // ч	248
    { 0x7C, 0x40, 0x7C, 0x40, 0x7C }, // ш	249
    { 0x3C, 0x20, 0x3C, 0x20, 0x7C }, // щ	250
    { 0x04, 0x7C, 0x48, 0x48, 0x30 }, // ъ	251
    { 0x7C, 0x48, 0x30, 0x00, 0x7C }, // ы	252
    { 0x7C, 0x48, 0x48, 0x48, 0x30 }, // ь	253
    { 0x28, 0x44, 0x54, 0x54, 0x38 }, // э	254
    { 0x7C, 0x10, 0x38, 0x44, 0x38 }, // ю	255
    { 0x58, 0x24, 0x24, 0x24, 0x7C }  // я	256
		};
